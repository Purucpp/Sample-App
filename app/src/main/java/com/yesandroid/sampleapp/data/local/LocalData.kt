package com.yesandroid.sampleapp.data.local

import android.content.Context
import android.content.SharedPreferences
import com.yesandroid.sampleapp.FAVOURITES_KEY
import com.yesandroid.sampleapp.SHARED_PREFERENCES_FILE_NAME
...
import com.yesandroid.sampleapp.data.error.PASS_WORD_ERROR
...
class LocalData @Inject constructor(val context: Context) {
    ...
    fun doLogin(loginRequest: LoginRequest): Resource<LoginResponse> {
        if (loginRequest == LoginRequest("purushottam@purushottam.purushottam", "purushottam")) {
            return Resource.Success(LoginResponse("123", "purushottam", "Mahmoud",
                    "FrunkfurterAlle", "77", "12000", "Berlin",
                    "Germany", "purushottam@purushottam.purushottam"))
        }
